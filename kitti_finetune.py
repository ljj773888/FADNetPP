...
def main():
    ...
    for r in range(start_round, train_round):
        ...
        for epoch in range(start_epoch, epoches[r] + 1):
            ...
            print(
                'epoch %d of round %d total training loss = %.3f' % (epoch, r, total_train_loss / len(TrainImgLoader)))
            ...
            print('epoch %d of round %d total 3-px error in val = %.3f, epe = %.3f.' % (
            epoch, r, total_test_loss / len(TestImgLoader) * 100, total_epe / len(TestImgLoader)))
